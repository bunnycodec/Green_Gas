...
function profile()
{
    global $con;
    $did = $_SESSION['did'];
    $query = "SELECT * FROM `dealer_register` WHERE UserId='$did'";
    ...
    <body>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown"> 
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="#" id="requests_nav">Requests</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="#" id="cylinder_nav">Cylinder Stock</a>
                            <div class="dropdown-divider"></div>
        ...
        <div class="main">
            ...
            <div id="requests">
                <div class="container">
                    <h1> REQUESTS </h1>
                    <table class="w3-table-all" id="cylinder_table">
                        <thead>
                            <tr class="w3-red">
                                <th>Customer ID</th>
                                <th>Customer Name</th>
                    ...
                    <form action="login.php" method="POST">
                        <input type="text" placeholder="Customer ID" name="cust_id"><br />
                        <input type="submit" name="dealer_providing_id" class="btn btn-primary" style="font-size: 2vh; width: 10vh;" value="SEND">
                    </form>
                </div>
            </div>
            <!--  Requests Ends  -->
            ...
            <div id="cylinder">
                <div class="container">
                    ...
                    <table class="w3-table-all" id="cylinder_table_2">
                        <thead>
                            <tr class="w3-red">
                                <th>Cylinder ID</th>
                    ...
                    <form action="login.php" method="POST">
                        ...
                        <input type="text" placeholder="Dealer Name" name="dealer_name"><br />
                        <input type="text" placeholder="Total Amount" name="cylinder_amount"><br />
                        <input type="submit" name="request_cylinder" class="btn btn-primary" style="font-size: 2vh; width: 20vh;" value="Request Cylinder">
                    </form>
                </div>
            </div>
            <!--  Cylinder Ends  -->
